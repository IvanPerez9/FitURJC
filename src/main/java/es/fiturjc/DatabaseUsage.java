...
public class DatabaseUsage implements CommandLineRunner {
	...
	public void run(String... arg0) {
		...
		User user1 = new User("William", "Wallace", 25, "pass", "ww@gmail.com", "WW",true, "ROLE_USER");
		user1.setImgSrc("/uploads/img/default");
		User user2 = new User("Travis", "Filmer", 29, "pass", "tt@gmail.com", "TF",true, "ROLE_USER");
		user2.setImgSrc("/uploads/img/default");
		User user3 = new User("Cillian", "Murphy", 28, "pass", "cm@gmail.com", "CM",true, "ROLE_USER");
		user3.setImgSrc("/uploads/img/default");
		// Admin user 
		
		User user4 = new User("Admin", "Admin", 25, "pass", "admin@gmail.com", "admin",true,"ROLE_USER", "ROLE_ADMIN");
        ...
        course1.setSrc("/img/courses/Aerobic.jpg");
		...
		course2.setSrc("/img/courses/Body Combat.jpg");
		...
		course10.setSrc("/img/courses/Boxing.jpg");
		...
		course11.setSrc("/img/courses/Cardio.jpg");
		...
		course12.setSrc("/img/courses/CrossFit.jpg");
		...
		course3.setSrc("/img/courses/Dumbbells.jpg");
		...
		course4.setSrc("/img/courses/Pilates.jpg");
		...
		course5.setSrc("/img/courses/Spinning.jpg");
		...
		course6.setSrc("/img/courses/Step.jpg");
		...
		course7.setSrc("/img/courses/Swiming.jpg");
		...
		course8.setSrc("/img/courses/Switching circuit.jpg");
		...
		course9.setSrc("/img/courses/Yoga.jpg");
